...
void Connection::handle_message_received(const char* data, std::size_t size)
{
    ...
    get_client_protocol().parse_message_received<Connection>(*this, StringView(data, size));
}
...
void Connection::handle_pong_received(const char* data, std::size_t size)
{
    ...
    get_client_protocol().parse_pong_received<Connection>(*this, StringView(data, size));
}
